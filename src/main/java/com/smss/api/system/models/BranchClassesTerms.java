...
public class BranchClassesTerms {
    ...
    private int bc_bid;
    private int bc_oid;
    private List<TermMapTermFee> termsdetails;
    ...
    public List<TermMapTermFee> getTermsdetails() {
        return termsdetails;
    }

    public void setTermsdetails(List<TermMapTermFee> termsdetails) {
